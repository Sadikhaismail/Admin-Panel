...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        const res = await axios.get("https://admin-panel-backend-b31l.onrender.com/api/admin/admin", {
  ...
  const handleLogout = async () => {
    try {
      await axios.post("https://admin-panel-backend-b31l.onrender.com/api/admin/logout", {}, { withCredentials: true });
